  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      <Card>
        ...
        <CardContent>
          {/* No per-month disbursement history is stored, so a real trend can't
              be derived — an empty state beats a fabricated series. */}
          <EmptyState
            title="Historical trend needs more data"
            description="Monthly disbursement trends will appear once payroll history is recorded."
          />
        </CardContent>
      </Card>
