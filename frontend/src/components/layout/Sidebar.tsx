        ...
        <div style={{
          ...
          {!isCollapsed && (
            <div style={{ overflow: "hidden" }}>
              <p style={{ fontSize: "14px", fontWeight: 700, color: "#fff", lineHeight: 1.2, letterSpacing: "0.01em" }}>
                EduManage
              </p>
              <p style={{ fontSize: "11px", color: "rgba(255,255,255,0.4)", marginTop: "2px", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
                Springdale School
              </p>
            </div>
          )}
