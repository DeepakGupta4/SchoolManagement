    ...
    >
      <div className="container-x">
        <SectionHeading
          ...
          description="Drag a trigger, drop a few actions, publish. Every module in BuildSchoolOS is available as a block — so a single admission can fan out into fees, messages and certificates automatically."
        />
